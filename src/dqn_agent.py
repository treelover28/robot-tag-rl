...
class DQN_Agent(Base_Agent):
    def __init__(self, agent_type, input_layer_size, output_layer_size, num_hidden_layers, hidden_layer_size, action_space, activation_function, activation_function_derivative, learning_rate, discount_factor, get_agent_state_function, agent_take_action_function, get_game_information): 
    ...
    def _get_action_q_values(self,remember_for_backprop):
    ...
    def _remember_experience(self, current_state, action, new_state, reward):
    ...
    def _experience_replay(self, mini_batch_size):
        if len(self.replay_buffer) > mini_batch_size:
            ...
            for idx in experience_indices:
                ...
                next_q_values = self._get_action_q_values(new_state, False)
                ...
                self._adjust_network_weights(current_q_values, target_q_values)

    def _adjust_network_weights(self,current_q_values, target_q_values):
    ...
    def learn(self, epsilon, time_to_apply_action = 0.33):
        ...
        self._remember_experience(current_state, chosen_action, new_state, reward)
        self._experience_replay(mini_batch_size= 32)
